...
if(isset($_POST['cariGuru'])){
    $teacher = cariGuru($_POST['keywordGuru']);
}
...
<form action="" method="get" class="form">
    <input type="text" name="keyword" autofocus placeholder="cari NIM" autocomplete="off" 
    value="<?= $keyword;  ?>" >
...
<form action="" method="post" >
    <input type="text" name="keywordGuru" autofocus placeholder="cari id guru" autocomplete="off" >
...
<form action="" method="post" >
    <input type="text" name="keywordId" autofocus placeholder="cari id admin" autocomplete="off" >
